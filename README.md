...
This is the repository for manuscript "Distributional welfare impacts and compensatory transit strategies under NYC congestion pricing"

  Folder "code" includes code for building the choice model and welfare impact analysis.
